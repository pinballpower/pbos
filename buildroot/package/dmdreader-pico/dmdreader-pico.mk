...
DMDREADER_PICO_VERSION=0.1.2
DMDREADER_PICO_BINARY_NAME=dmdreader-$(DMDREADER_PICO_VERSION).elf
DMDREADER_PICO_SOURCE=$(DMDREADER_PICO_BINARY_NAME)
DMDREADER_PICO_SITE=https://github.com/pinballpower/code_dmd/releases/download/v$(DMDREADER_PICO_VERSION)
...
define DMDREADER_PICO_INSTALL_TARGET_CMDS
    ...
    $(INSTALL) -D -m 0644 $(DMDREADER_PICO_DL_DIR)/$(DMDREADER_PICO_BINARY_NAME) $(TARGET_DIR)/firmware/dmdreader.elf
